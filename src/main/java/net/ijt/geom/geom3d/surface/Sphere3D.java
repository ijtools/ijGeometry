 ...
 * 
 */
package net.ijt.geom.geom3d.surface;

import java.util.ArrayList;
import java.util.Collection;

import net.ijt.geom.geom2d.Point2D;
import net.ijt.geom.geom2d.curve.Circle2D;
import net.ijt.geom.geom3d.Bounds3D;
import net.ijt.geom.geom3d.Geometry3D;
import net.ijt.geom.geom3d.Plane3D;
import net.ijt.geom.geom3d.Point3D;
import net.ijt.geom.geom3d.StraightLine3D;
